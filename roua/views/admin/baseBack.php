...
<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i
                        class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">Users</span><i
                        class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
                <li><a class="treeview-item" href="<?php echo curPageURL() ?>/views/admin/users"><i
                                class="icon fa fa-circle-o"></i>List</a></li>
            
            </ul>
        </li>
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i
                        class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">Cards</span><i
                        class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
                <li><a class="treeview-item" href="<?php echo curPageURL() ?>/views/admin/fidelity"><i
                                class="icon fa fa-circle-o"></i>List</a></li>
                                 <li><a class="treeview-item" href="<?php echo curPageURL() ?>/views/admin/fidelity/add.php"><i
                                class="icon fa fa-circle-o"></i>add</a></li>
                 <li><a class="treeview-item" href="<?php echo curPageURL() ?>/views/admin/requests"><i
